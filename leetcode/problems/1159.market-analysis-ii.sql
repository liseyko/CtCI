--
-- @lc app=leetcode id=1159 lang=mysql
--
...
-- 
-- 
-- Write an SQL query to find for each user, whether the brand of the second
-- item (by date) they sold is their favorite brand. If a user sold less than
-- two items, report the answer for that user as no.
-- 
...
-- The answer for the user with id 4 is no because the brand of their second
-- sold item is not their favorite brand.
-- 
--
