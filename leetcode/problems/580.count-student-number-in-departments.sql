...
--
-- A university uses 2 data tables, student and department, to store data about
-- its students and the departments associated with each major.
-- 
...
-- departments have the same number of students, then sort those departments
