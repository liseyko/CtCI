--
-- @lc app=leetcode id=1225 lang=mysql
--
...
-- tasks in this interval succeeded. Interval of days are retrieved as
...
-- +--------------+--------------+--------------+
-- 
-- The report ignored the system state in 2018 as we care about the system in
-- the period 2019-01-01 to 2019-12-31.
-- From 2019-01-01 to 2019-01-03 all tasks succeeded and the system state was
-- "succeeded".
-- From 2019-01-04 to 2019-01-05 all tasks failed and system state was
-- "failed".
