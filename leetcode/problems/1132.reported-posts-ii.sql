...
-- for report or a type of reaction. 
-- 
-- Table: Removals
-- 
-- 
...
-- Each row in this table indicates that some post was removed as a result of
-- being reported or as a result of an admin review.
-- 
-- 
-- 
-- 
-- Write an SQL query to find the average for daily percentage of posts that
-- got removed after being reported as spam, rounded to 2 decimal places.
-- 
