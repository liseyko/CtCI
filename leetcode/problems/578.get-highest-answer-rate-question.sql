...
-- columns: uid, action, question_id, answer_id, q_num, timestamp.
-- 
-- uid means user id; action has these kind of values: "show", "answer",
-- "skip"; answer_id is not null when action column is "answer", while is null
-- for "show" and "skip"; q_num is the numeral order of the question in current
-- session.
-- 
