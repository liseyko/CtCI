...
-- Testcase Example:  '{"headers": {"Teams": ["team_id", "team_name"], "Matches": ["match_id", "host_team", "guest_team", "host_goals", "guest_goals"]}, "rows": {"Teams": [[10, "Leetcode FC"], [20, "NewYork FC"], [30, "Atlanta FC"], [40, "Chicago FC"], [50, "Toronto FC"]], "Matches": [[1, 10, 20, 30, 0], [2, 30, 10, 2, 2], [3, 10, 50, 5, 1], [4, 20, 30, 1, 0], [5, 50, 30, 1, 0]]}}\r'
--
-- Table: Teams
-- 
-- 
...
-- each team in the tournament after all described matches. Result table should
-- be ordered by num_points (decreasing order). In case of a tie, order the
-- records by team_id (increasing order).
-- 
