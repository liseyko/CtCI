--
-- @lc app=leetcode id=579 lang=mysql
--
...
-- 
-- Write a SQL to get the cumulative sum of an employee's salary over a period
-- of 3 months but exclude the most recent month.
-- 
...
-- recent month '4': salary 40 for month '3', 30 for month '2' and 20 for month
-- '1'
